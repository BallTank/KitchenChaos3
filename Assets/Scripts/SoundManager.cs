...
public class SoundManager : MonoBehaviour {
    ...
    private void Start() {
        ...
        TrashCounter.OnAnyOjbectTrashed += TrashCounter_OnAnyObjectTrashed;
    }
    ...
    private void PlaySound(AudioClip[] audioClipArray, Vector3 position, float volume = 1f) {
        PlayerSound(audioClipArray[Random.Range(0, audioClipArray.Length)], position, volume);
    }

    private void PlayerSound(AudioClip audioClip, Vector3 position, float volumeMultiplier = 1f) {
